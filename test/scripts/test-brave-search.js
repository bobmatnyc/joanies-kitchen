...
const routePath = path.join(__dirname, '@/app/api/brave-search/route.ts');
...
const clientPath = path.join(__dirname, '@/lib/brave-search.ts');
...
const examplePath = path.join(__dirname, '@/components/example-brave-search.tsx');
